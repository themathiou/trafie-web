trafie.controller("settingsController", function(
  ...
  $scope.submitChangeSetting = function( setting ) {
    ...
    switch(setting){
       ...
       */
      case 'profile_pic':
        data = { "profile_pic" : $scope.localUser.new_profile_pic };
        ...
        break;
      case 'first_name':
        data = { "first_name" : $scope.localUser.new_first_name  };
        console.log(data);
        $http.post('/settings_data', data)
        .success(function(res){
          if( res.success ) {
        ...
        break;
      case 'last_name':
        data = { "last_name" : $scope.localUser.new_last_name  };
        console.log(data);
        $http.post('/settings_data', data)
        .success(function(res){
          if( res.success ) {
        ...
        break;
      case 'discipline':
        data = { "discipline" : $scope.localUser.new_main_discipline };
        console.log(data);
        $http.post('/settings_data', data)
        .success(function(res){
          if( res.success ) {
        ...
        break;
      case 'privacy':
        data = { "private" : $scope.localUser.new_privacy };
        console.log(data);
        $http.post('/settings_data', data)
        .success(function(res){
          if( res.success ) {
        ...
        break;
      case 'gender':
        data = { "gender" : $scope.localUser.gender  };
        console.log(data);
        $http.post('/settings_data', data)
        .success(function(res){
          if( res.success ) {
      ...
      case 'birthday':
        ...
        break;
      case 'country':
        data = { "country" : $scope.localUser.country };
        console.log(data);
        $http.post('/settings_data', data)
        .success(function(res){
          if( res.success ) {
        ...
        break;
      case 'about':
        data = { "about" : $scope.localUser.new_about };
        $http.post('/settings_data', data)
        .success(function(res){
          if( res.success ) {
      ...
      case 'password':
        break;
      case 'language':
        data = { "language" : $scope.localUser.new_language  };
        console.log(data);
        $http.post('/settings_data', data)
        .success(function(res){
          if( res.success ) {
        ...
        break;
      case 'date-format':
        data = { "date_format" : $scope.localUser.date_format };
        console.log(data);
        $http.post('/settings_data', data)
        .success(function(res){
          if( res.success ) {
        ...
        break;
      case 'username':
        data = { "username" : $scope.localUser.new_username };
        console.log(data);
        $http.post('/settings_data', data)
        .success(function(res){
          if( res.success ) {

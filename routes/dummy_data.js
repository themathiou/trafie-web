...
function create_user( max_users, res ) {
	if( counter < max_users ) {
	    ...
	    var new_user = {
	      'email': first_name.toLowerCase() + delimiter + last_name.toLowerCase() + '@trafie.com',
	    ...
	    var new_profile = {
	      ...
	      'last_name': last_name,
	      'username': first_name.toLowerCase() + delimiter + last_name.toLowerCase()
	    };
